...
<div class="container">
    ...
    <main>
        ...
        <div class="col-md-7 col-lg-8">
            ...
            <form action="/update/{{ $funcionarios->id }}" method="POST" name="formCad" id="formCad">
            @csrf
            @method('PUT')
            <div class="row g-3">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="text"  class="form-control" name="nome" value="{{ $funcionarios->nome }}"  required>
               
                </div>

                <div class="col-sm-6">
                  <label for="carteira_trabalho" class="form-label">Carteira de Trabalho</label>
                  <input type="text" name="carteira_trabalho" class="form-control" value="{{ $funcionarios->carteira_trabalho }}"  required>
                ...
                <div class="col-sm-6">
                  ...
                  <input type="text" name="cpf" class="form-control" id="cpf" value="{{ $funcionarios->cpf }}"  required>
                ...
                <div class="col-md-6">
                  ...
                  <select class="form-select" id="setor" name="setor" required>
                      <option value="{{ $funcionarios->setor }}"> {{ $funcionarios->setor }} </option>
